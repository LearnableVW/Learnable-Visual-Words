...
class PPNet(nn.Module):
    ...
    def __init__(self, features, img_size, prototype_shape,
        ...
        # print(add_on_layers_type == 'bottleneck')
        if add_on_layers_type == 'bottleneck':
            add_on_layers = []
            current_in_channels = first_add_on_layer_in_channels
            # print(current_in_channels > self.prototype_shape[1])
            # print(len(add_on_layers) == 0)
    ...
    def _l2_convolution(self, x):
        ...
        # print('x: ', x.size())
        # print("prototypes: ", self.prototype_vectors.size())
    ...
    def prototype_distances(self, x):
        ...
        # print("conv_features: ", conv_features.size())
        # print('distances: ', distances.size())
        return distances
    ...
    def forward(self, x):
        ...
        # print('prototype_activation_patterns', prototype_activation_patterns.size())
        # prototype_activation_patterns = F.interpolate(prototype_activation_patterns, [self.img_size, self.img_size], mode='bilinear', align_corners=True)
        # prototype_activation_patterns = torch.max(prototype_activation_patterns, dim=1)[0]
        ...
        min_distances = -F.max_pool2d(-distances,
                                      kernel_size=(distances.size()[2],
                                                   distances.size()[3]))
        # print('min_distances', min_distances.size())
        min_distances = min_distances.view(-1, self.num_prototypes)
        prototype_activations = self.distance_2_similarity(min_distances)
        # print("prototype_activations", prototype_activations.size())
        # print('min_distances', min_distances.size())
        ...
        # largest = torch.topk(min_distances, 20, dim=1).indices
        # print('largest', largest.size()) 

        # largest = largest.unsqueeze(-1).unsqueeze(-1).expand(largest.shape[0], 20, prototype_activation_patterns.shape[2], prototype_activation_patterns.shape[3])

        # print('largest', largest.size()) 

        # k_patterns = torch.gather(prototype_activation_patterns, dim=1, index = largest)
        
        # print('prototype_activation_patterns', k_patterns.size())
